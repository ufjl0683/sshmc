    ...
    public partial class Form1 : Form
    {
        public Form1()
        {
          ...
          //  this.axCExpressViewerControl1.EditMode = false;
           ...
           // axCExpressViewerControl1.ECompositeViewer
            ECompositeViewer.IAdECompositeViewer CompositeViewer = (ECompositeViewer.IAdECompositeViewer)axCExpressViewerControl1.ECompositeViewer;
      ...
      //     MessageBox.Show(TypeName);
           ...
           foreach (ECompositeViewer.IAdObject obj in objects)
           {
               ...
               {
                   if (prop.Name == "Id" &&  prop.Value == "475841"/* || prop.Value=="475848")*/)
                   {
