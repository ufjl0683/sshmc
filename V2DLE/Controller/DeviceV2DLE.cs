...
namespace Comm.Controller
{
    ...
    public class DeviceV2DLE :Comm.I_DLE
    {
     public    const   byte DLE = 0x10;
      ...
      //  public  ISCmdValidCheckTemplate  IsValidCCmdFuncPtr;  //chk cmd range valid function
        ...
        public DeviceV2DLE(string devName, System.IO.Stream stream)
        {
                        ...
                        case SOH:
                            ...
                            {  
                              ...
                              //  Console.WriteLine("<onReceiveText>" + TxtPkg.ToString());
                                ...
                                //------------------------------------ack----------------------------------------------------------------
                                if (TxtPkg.Text[0] != 0x04  && !TxtPkg.IsQueryCmd )
                                {
                                    AckData[0] = DLE;
                                    AckData[1] = ACK;
