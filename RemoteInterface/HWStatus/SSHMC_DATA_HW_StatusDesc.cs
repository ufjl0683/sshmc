 ...
 * */
    ...
    public enum SSHMC_HW_Status_Bit_Enum
    {
        DeviceErr = 0,
        CabineteOpen = 1,
        PortableTest = 2,
  ...
  public  class SSHMC_DATA_HW_StatusDesc : I_HW_Status_Desc
    {
        ...
        byte[] diff;
         string devName;
      byte[] m_status;
         public SSHMC_DATA_HW_StatusDesc(string devName,byte[] hw_status, byte[] diff)
        {
         ...
         public SSHMC_DATA_HW_StatusDesc(string devName, byte[] hw_status)
